...
class SecurityController extends AbstractController
{
    ...
    public function signup(Request $request, UserPasswordHasherInterface $userPasswordHasherInterface, EntityManagerInterface $em, UserAuthenticatorInterface $userAuthenticator): Response
    {
        $user = new User();
